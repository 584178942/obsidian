 ...
 * @since 2020-10-15
 */
public class ActiveModeActivity extends ComponentActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        int id = view.getId();
        if (id == R.id.btn_user_active_admin) {
            userActiveAdmin();
        } else if (id == R.id.btn_force_active_admin) {
            forceActiveAdmin();
        } else if (id == R.id.btn_delay_active_admin) {
            delayDeactiveAdmin();
        }
    }
