...
package com.siyu.mdm.custom.device.sample;
...
public class MainActivity extends Activity {
    ...
    private void initWifiView() {
        mWifiStatusText = findViewById(R.id.wifiStateTxt);
    ...
    private void initCloseButton() {
        ...
        try {
            ...
            LogUtils.e(TAG, "illegal class name in intent");
        }
    }
    ...
    private void updateState() {
        ...
        try {
            ...
            LogUtils.d("securityException", Objects.requireNonNull(securityException.getLocalizedMessage()));
