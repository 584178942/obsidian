 ...
 * @since 2022-07-13
 */
public class    ActiveActivity extends ComponentActivity {
    ...
    private void dealBeLaunched() {
        ...
        try {
            if (intent != null && isDuringSetupWizard(mActivity)
                ...
                isOobe = true;
                hemInstance.activeLicense();
                LogUtils.i(TAG, "current activity is launched during the setup wizard flow");
            }
        } catch (BadParcelableException e) {
            LogUtils.i(TAG, "illegal class name in intent");
        }
    }
        ...
        public void onStatus(final int errorCode, final String msg) {
            if (isOobe) {
                ...
                if (errorCode == LICENSE_ACTIVATE_SUCCESS) {
                    ...
                    LogUtils.v(TAG, "Other errorCode do not need to handle.");
                }
            }
        }
    }
